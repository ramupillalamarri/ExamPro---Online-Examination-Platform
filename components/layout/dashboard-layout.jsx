  ...
  useEffect(() => {
    if (isHydrated && mounted && !isSwitchingRole) {
      if (!isAuthenticated) {
        ...
        if (pathname.startsWith("/admin") && currentRole === "student") {
          router.push("/student")
        } else if ((pathname.startsWith("/student") || pathname.startsWith("/attempts")) && (currentRole === "teacher" || currentRole === "admin")) {
          router.push("/admin")
        }
      }
    }
