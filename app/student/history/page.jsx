...
const RankBadge = ({ rank }) => {
  ...
  let trophyColor = "text-amber-500 fill-amber-100"
  let rankBg = "bg-amber-50 border-amber-200"
  let rankText = `#${rank}`
...
export default function StudentHistoryPage() {
  ...
  return (
    <div className="p-4 md:p-6 lg:p-8 space-y-6 min-h-screen bg-[#f8fafc] font-sans antialiased">
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl md:text-2xl font-black text-slate-800 tracking-tight leading-none">My Attempts</h1>
                  ...
                  <div className="flex justify-between items-center">
                    <div>
                      ...
                      <CardDescription className="text-[11.5px] font-bold text-slate-400">
                        Detailed statistics and scores for your {filteredAttempts.length} search result{filteredAttempts.length > 1 ? "s" : ""}
                      </CardDescription>
                    </div>
                  </div>
                </CardHeader>
